...
-------------------------------------------------------------------------
Date = "20200630"--Type Here Your Script End Date .
date = os.date("%Y%m%d")
if date >= Date then
...
if MCADM [1] == true then whk8895() end
if MCADM [2] == true then ClickADM() end
if MCADM [3] == true then PERTAMA()  end 
end
MCPBO1 = -1
end
function whk8895()
